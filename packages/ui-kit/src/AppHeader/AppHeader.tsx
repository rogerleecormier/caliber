...
export function AppHeader({
  ...
  const searchBoxElement = (
    <button
      ...
      className="hidden md:flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50/50 hover:bg-slate-100 px-3 py-2 text-sm text-slate-600 transition min-w-0 w-1/3 ml-auto"
    >
