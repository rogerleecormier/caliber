/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 66f1468f94bdc3add19b2a45da49f466)
// Runtime types generated with workerd@1.20260521.1 2025-11-30 nodejs_compat
interface __BaseEnv_Env {
	KV: KVNamespace;
	R2: R2Bucket;
	DB: D1Database;
	VECTORIZE: VectorizeIndex;
	JOB_INGESTION_QUEUE: Queue;
	SCRAPE_REQUEST_QUEUE: Queue;
	CRAWL_JOBS_QUEUE: Queue;
	BROWSER: Fetcher;
	AI: Ai;
	...
	RATE_LIMITER: DurableObjectNamespace<import("./worker").RateLimiter>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADZUNA_API_KEY" | "JOOBLE_API_KEY" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL">> {}
}
